...
namespace inebase.Exchange.Gateway.Infrastructure.Services
{
    ...
    public partial class CryptoClient
    {
        ...
        public CryptoClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        public async System.Threading.Tasks.Task<GenerateAddressCommandResult> AddressesAsync(GenerateAddressCommand command, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Crypto/Addresses");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GenerateAddressCommandResult>(response_, headers_).ConfigureAwait(false);
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<AddressesQueryResult>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ != "200" && status_ != "204")
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PublishTransactionCommandResult> PublishAsync(PublishTransactionCommand command)
        {
            return PublishAsync(command, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PublishTransactionCommandResult> PublishAsync(PublishTransactionCommand command, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Crypto/Publish");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PublishTransactionCommandResult>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ != "200" && status_ != "204")
    ...
    public partial class GenerateAddressCommandResult
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.7.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GenerateAddressCommand
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.7.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class AddressesQueryResult
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.7.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class PublishTransactionCommandResult
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.7.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class PublishTransactionCommand
    {
        [Newtonsoft.Json.JsonProperty("currency", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Currency Currency { get; set; }
